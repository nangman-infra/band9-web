...
const dayButtonStyle = (isCurrentMonth: boolean, isToday: boolean) => css`
  background: ${isToday ? '#667eea' : isCurrentMonth ? 'white' : '#f5f5f5'};
  border: ${isToday ? '2px solid #5568d3' : '1px solid #e0e0e0'};
  border-radius: 8px;
  padding: 1rem;
  cursor: pointer;
  color: ${isToday ? 'white' : isCurrentMonth ? '#333' : '#999'};
  font-size: 1rem;
  font-weight: ${isToday ? '600' : '400'};
  transition: all 0.2s;

  &:hover {
    background: ${isToday ? '#5568d3' : '#f0f0f0'};
